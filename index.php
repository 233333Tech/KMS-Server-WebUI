            ...
            <div class="well">
                ...
                <form action="./kms.php" method="get" role="form">
                    ...
                    <div style="background: #f0f8e5;line-height: 1;padding: 10px;border-left: 3px solid #86cc00;">
                        <div class="text" style=" text-align:center;">感谢 <a href="https://github.com/lichenzero/KMS-Server-WebUI" target="_blank">零号地衣</a>、<a href="https://www.moerats.com/archives/824/" target="_blank">Rat's博客</a>、<a href="https://mikuac.com" target="_blank">Zero</a>、<a href="https://lolico.moe/" target="_blank">綺凜</a> 这些开源社区的贡献者们！
                        <div class="text" style=" text-align:center;">Github项目地址: <a href="https://github.com/lichenzero/KMS-Server-WebUI" target="_blank">原项目地址</a> <a href="https://github.com/233333Tech/KMS-Server-WebUI" target="_blank">本站分支</a>
                        <div class="text" style=" text-align:center;">Powered By <a href="https://233333.info/" target="_blank">233333Tech</a> with ❤ ~ </div>
                    </div>
                </form>
            </div>
        </div>
...
<div id="cc-myssl-id" style="position: fixed;right: 0;bottom: 0;width: 65px;height: 65px;z-index: 99;">
    <a href="https://myssl.com/kms.233333.me?from=mysslid"><img src="https://static.myssl.com/res/images/myssl-id.png" alt="" style="width:100%;height:100%"></a>
</div>
